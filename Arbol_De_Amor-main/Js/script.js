...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Para ti Jilary Tu eres una niña unica en mi vida aunque al inicio te veia como una amistad eso fue cambiando al punto de que ahora eres la niña de mis pensamientos todo el tiempo .`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Te quiero Jilary";
...
function showCountdown() {
  ...
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('3100-08-15T00:00:00');
  ...
  function update() {
    ...
    container.innerHTML =
      `desde que estas en mis pensamientos : <b>${days}</b> días<br>` +
      `cuando te deje de pensar : <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
